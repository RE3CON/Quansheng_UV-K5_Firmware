...
strings = [
    ...
    (0xDC96+7*11, 'busy channel ptt lock'           , 6, 'B-LOCK'),
    ...
    (0xDC96+7*48, 'enable NOAA scan'                , 6, 'PMR-SC'),
    ...
    (0xDC96+7*56, 'enable scrambler option'         , 6, 'SCRAMB' ),
    ...
    (0xDE39+5*0 , 'tx power: low'                   , 4, '1W'   ),
    (0xDE39+5*1 , 'tx power: mid'                   , 4, '3W'   ),
    (0xDE39+5*2 , 'tx power: high'                  , 4, '5W'  ),
