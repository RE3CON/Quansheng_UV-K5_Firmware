...
strings = [
    ...
    (0xDC96+7*10, 'scramble'                        , 6, 'SCRAMB'),
    (0xDC96+7*11, 'busy channel ptt lock'           , 6, 'BCLPTT'),
    (0xDC96+7*12, 'save channel'                    , 6, 'MEM-CH'),
    (0xDC96+7*13, 'battery saver'                   , 6, 'SAVE'  ),
    (0xDC96+7*14, 'voice activated mode'            , 6, 'VOX'   ),
    (0xDC96+7*15, 'backlight timeout'               , 6, 'LIGHTT'),
    ...
    (0xDC96+7*46, 'battery voltage'                 , 6, 'VOLT'  ),
    (0xDC96+7*47, 'enable AM reception on AM bands' , 6, 'AM'    ),
    (0xDC96+7*48, 'enable NOAA scan'                , 6, 'PMR_SC'),
    ...
    (0xDC96+7*56, 'enable scrambler option'         , 6, 'SCR-EN' ),
    ...
    (0xDE39+5*0 , 'tx power: low'                   , 2, '1W'   ),
    (0xDE39+5*1 , 'tx power: mid'                   , 2, '3W'   ),
    (0xDE39+5*2 , 'tx power: high'                  , 2, '5W'  ),
    ...
    (0xDEC1+5*2 , 'power on screen: batt voltage'   , 4, 'VOLT'   ),
